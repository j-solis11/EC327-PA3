...
OBJS= main.o Building.o Point2D.o Vector2D.o GameObject.o PokemonCenter.o PokemonGym.o Trainer.o Model.o GameCommand.o View.o

default: finalcheckpoint
...
Building.o: Building.cpp Building.h GameObject.h Point2D.h Vector2D.h
...
main.o: main.cpp Building.h Point2D.h Vector2D.h PokemonCenter.h PokemonGym.h GameObject.h Model.h Trainer.h GameCommand.h View.h
...
checkpoint4: TestCheckPoint4.cpp Point2D.o Vector2D.o GameObject.o Building.o PokemonCenter.o PokemonGym.o Trainer.o Model.o GameCommand.o  View.o
	$(CC) -o checkpoint4.exe TestCheckPoint4.cpp Point2D.o Vector2D.o GameObject.o Building.o PokemonCenter.o PokemonGym.o Trainer.o Model.o GameCommand.o View.o
